...
namespace UGKit.Editor
{
    ...
    public static class LogScriptingDefineSymbols
    {
        ...
        /// 禁用所有日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Disable All Logs(禁用所有日志脚本宏定义)", false, 30)]
        ...
        /// 开启所有日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable All Logs(开启所有日志脚本宏定义)", false, 31)]
        ...
        /// 开启调试及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable Debug And Above Logs(开启调试及以上级别的日志脚本宏定义)", false, 32)]
        ...
        /// 开启信息及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable Info And Above Logs(开启信息及以上级别的日志脚本宏定义)", false, 33)]
        ...
        /// 开启警告及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable Warning And Above Logs(开启警告及以上级别的日志脚本宏定义)", false, 34)]
        ...
        /// 开启错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable Error And Above Logs(开启错误及以上级别的日志脚本宏定义)", false, 35)]
        ...
        /// 开启严重错误及以上级别的日志脚本宏定义。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable Fatal And Above Logs(开启严重错误及以上级别的日志脚本宏定义)", false, 36)]
