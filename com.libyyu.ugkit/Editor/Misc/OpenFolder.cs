...
namespace UGKit.Editor
{
    ...
    public static class OpenFolder
    {
        ...
        /// 打开 Data Path 文件夹。
        /// </summary>
        [MenuItem("UGKit/Open Folder/Data Path(打开Data Path文件夹)", false, 10)]
        ...
        /// </summary>
        [MenuItem("UGKit/Open Folder/Persistent Data Path(打开Persistent Data Path文件夹)", false, 11)]
        ...
        /// </summary>
        [MenuItem("UGKit/Open Folder/Streaming Assets Path(打开Streaming Assets Path文件夹)", false, 12)]
        ...
        /// </summary>
        [MenuItem("UGKit/Open Folder/Temporary Cache Path(打开Temporary Cache Path文件夹)", false, 13)]
        ...
        /// </summary>
        [MenuItem("UGKit/Open Folder/Console Log Path(打开Console Log Path文件夹)", false, 14)]
