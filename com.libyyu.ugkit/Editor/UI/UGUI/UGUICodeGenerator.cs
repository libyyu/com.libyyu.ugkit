...
namespace UGKit.UI.UGUI.Editor
{
    ...
    internal static class UGUICodeGenerator
    {
        ...
        private static string GenerateCode(GameObject selectedObject, string assetPath)
        {
            ...
            codeBuilder.AppendLine("using UGKit.Entity.Runtime;");
            codeBuilder.AppendLine("using UGKit.UI.Runtime;");
            codeBuilder.AppendLine("using UGKit.Runtime;");
            codeBuilder.AppendLine("using UGKit.UI.UGUI.Runtime;");
