...
namespace UGKit.Editor
{
    ...
    {
        [MenuItem("UGKit/Package Manager(UGKit的包管理器)", false, 2000)]
        public static void ShowWindow()
        {
            var window = GetWindow<PackageManagerWindow>("UGKit");
            ...
            if (selectedItem != null)
            {
                ...
                else
                {
                    if (selectedItem.Versions.Count > 0)
                    {
                        ...
                        {
                            Application.OpenURL("https://github.com/UGKit/UGKit.Unity/issues/new");
                        }
                    ...
                    else
                    {
                        ...
                        if (GUILayout.Button("打开反馈页面https://github.com/libyyu/com.libyyu.unity.git", GUILayout.Height(100)))
                        {
                            Application.OpenURL("https://github.com/libyyu/com.libyyu.unity.git");
                        }
                    }
                }
            }
