...
namespace UGKit.Editor
{
    ...
    public static class BuildHotfixHelper
    {
        ...
        /// 复制热更新代码
        /// </summary>
        [MenuItem("UGKit/Build/Copy HotFix Code(复制热更新代码到Assets>Bundles>Code)", false, 10)]
        ...
        /// 复制AOT代码
        /// </summary>
        [MenuItem("UGKit/Build/Copy AOT Code(复制AOT代码到Assets>Bundles>AOTCode)", false, 11)]
        ...
        /// 开启 HybridCLR 的支持。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Disable HybridCLR(关闭HybridCLR适配)", false, 5000)]
        ...
        /// 关闭 HybridCLR 的支持。
        /// </summary>
        [MenuItem("UGKit/Scripting Define Symbols/Enable HybridCLR(开启HybridCLR适配)", false, 5001)]
