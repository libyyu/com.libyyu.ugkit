...
namespace UGKit.Runtime
{
    ...
    public sealed class BaseComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private string m_TextHelperTypeName = "UGKit.Runtime.DefaultTextHelper";

        [SerializeField] private string m_VersionHelperTypeName = "UGKit.Runtime.DefaultVersionHelper";

        [SerializeField] private string m_LogHelperTypeName = "UGKit.Runtime.DefaultLogHelper";

        [SerializeField] private string m_CompressionHelperTypeName = "UGKit.Runtime.DefaultCompressionHelper";

        [SerializeField] private string m_JsonHelperTypeName = "UGKit.Runtime.NewtonsoftJsonHelper";
