...
namespace UGKit.Setting.Runtime
{
    /// <summary>
    /// 游戏配置组件。
    /// </summary>
    [DisallowMultipleComponent]
    [AddComponentMenu("UGKit/Framework/Setting")]
    [UnityEngine.Scripting.Preserve]
    public sealed class SettingComponent : GameFrameworkComponent
    {
        private ISettingManager m_SettingManager = null;

        private bool m_bHasLoaded = false;

        [SerializeField] private string m_SettingHelperTypeName = "UGKit.Setting.Runtime.DefaultSettingHelper";
        ...
        private void LoadIfNeed()
        {
            if(!m_bHasLoaded)
            {
                ...
                m_bHasLoaded = true;
                Log.Info("Load settings successed!");
            }
        }
