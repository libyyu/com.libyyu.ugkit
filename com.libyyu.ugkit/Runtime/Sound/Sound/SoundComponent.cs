...
namespace UGKit.Sound.Runtime
{
    ...
    public sealed partial class SoundComponent : GameFrameworkComponent
    {
        ...
        [SerializeField] private string m_SoundHelperTypeName = "UGKit.Sound.Runtime.DefaultSoundHelper";

        [SerializeField] private SoundHelperBase m_CustomSoundHelper = null;

        [SerializeField] private string m_SoundGroupHelperTypeName = "UGKit.Sound.Runtime.DefaultSoundGroupHelper";

        [SerializeField] private SoundGroupHelperBase m_CustomSoundGroupHelper = null;

        [SerializeField] private string m_SoundAgentHelperTypeName = "UGKit.Sound.Runtime.DefaultSoundAgentHelper";
