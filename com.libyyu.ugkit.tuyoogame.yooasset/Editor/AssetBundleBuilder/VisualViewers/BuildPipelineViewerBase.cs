...
namespace YooAsset.Editor
{
    internal abstract class BuildPipelineViewerBase
    {
        ...
        protected void BuildVersionHandler(TemplateContainer root)
        {
            // 新版本号按钮
            var buildNewVersionNumberButton = root.Q<Button>("BuildNewVersionNumber");
            buildNewVersionNumberButton.clicked += BuildNewVersionNumberButton_clicked;
        }

        protected void BuildNewVersionNumberButton_clicked()
        {
